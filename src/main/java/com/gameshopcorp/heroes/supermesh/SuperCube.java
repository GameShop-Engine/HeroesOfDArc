...
public class SuperCube {
    ...
    public SuperCube(SuperSquare top, SuperSquare bottom, SuperSquare front, SuperSquare back, SuperSquare left, SuperSquare right){
        ...
        SuperJoin right20 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right"), superMesh.superMesh.get("back") }, new Vector2f[]{new Vector2f(2,0), new Vector2f(0,2)});;
        SuperJoin right21 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right")}, new Vector2f[]{new Vector2f(2,1)});;
        SuperJoin right22 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right")}, new Vector2f[]{new Vector2f(2,2)});;
        SuperJoin right23 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(2,3), new Vector2f(0,2)});;


        SuperJoin right30 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right"), superMesh.superMesh.get("back"), superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(3,0), new Vector2f(0,0), new Vector2f(3,0)});;
        SuperJoin right31 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right"), superMesh.superMesh.get("top")}, new Vector2f[]{ new Vector2f(3,1), new Vector2f(1,3)});;
        SuperJoin right32 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right"), superMesh.superMesh.get("top")}, new Vector2f[]{ new Vector2f(3,2), new Vector2f(2,3)});;
        SuperJoin right33 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("right"), superMesh.superMesh.get("front"), superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(3,3), new Vector2f(0,0), new Vector2f(3,3)});;

        //
        
        SuperJoin top00 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("left"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,0), new Vector2f(3,0), new Vector2f(3,0)});;
        SuperJoin top01 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,1), new Vector2f(3,0)});;
        SuperJoin top02 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,2), new Vector2f(3,0)});;
        SuperJoin top03 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("right"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,3), new Vector2f(3,0), new Vector2f(0,0)});;

        //

        SuperJoin top10 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("left")}, new Vector2f[]{new Vector2f(1,0), new Vector2f(3,1)});;
        SuperJoin top11 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(1,1)});;
        SuperJoin top12 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(1,2)});;
        SuperJoin top13 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("right")}, new Vector2f[]{new Vector2f(1,3), new Vector2f(3,1)});;

        //

        SuperJoin top20 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("left")}, new Vector2f[]{new Vector2f(2,0), new Vector2f(3,2)});;
        SuperJoin top21 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(2,1)});;
        SuperJoin top22 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(2,2)});;
        SuperJoin top23 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("right")}, new Vector2f[]{new Vector2f(2,3), new Vector2f(3,2)});;

        //

        SuperJoin top30 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("left"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,0), new Vector2f(3,0), new Vector2f(3,0)});;
        SuperJoin top31 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,1), new Vector2f(3,0)});;
        SuperJoin top32 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,2), new Vector2f(3,0)});;
        SuperJoin top33 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("top"), superMesh.superMesh.get("right"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,3), new Vector2f(3,0), new Vector2f(0,0)});;

        //

        SuperJoin bottom00 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("left"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,0), new Vector2f(3,0), new Vector2f(3,0)});;
        SuperJoin bottom01 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,1), new Vector2f(3,0)});;
        SuperJoin bottom02 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,2), new Vector2f(3,0)});;
        SuperJoin bottom03 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("right"), superMesh.superMesh.get("back")}, new Vector2f[]{new Vector2f(0,3), new Vector2f(3,0), new Vector2f(0,0)});;

        //

        SuperJoin bottom10 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("left")}, new Vector2f[]{new Vector2f(1,0), new Vector2f(3,1)});;
        SuperJoin bottom11 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom")}, new Vector2f[]{new Vector2f(1,1)});;
        SuperJoin bottom12 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom")}, new Vector2f[]{new Vector2f(1,2)});;
        SuperJoin bottom13 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("right")}, new Vector2f[]{new Vector2f(1,3), new Vector2f(3,1)});;

        //

        SuperJoin bottom20 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("left")}, new Vector2f[]{new Vector2f(2,0), new Vector2f(3,2)});;
        SuperJoin bottom21 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom")}, new Vector2f[]{new Vector2f(2,1)});;
        SuperJoin bottom22 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom")}, new Vector2f[]{new Vector2f(2,2)});;
        SuperJoin bottom23 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("right")}, new Vector2f[]{new Vector2f(2,3), new Vector2f(3,2)});;
...
//        SuperJoin bottom23 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("back"), superMesh.superMesh.get("left"), superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(3,0), new Vector2f(3,0), new Vector2f(0,0)});;
        ...
        SuperJoin bottom30 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("left"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,0), new Vector2f(3,0), new Vector2f(3,0)});;
        SuperJoin bottom31 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,1), new Vector2f(3,0)});;
        SuperJoin bottom32 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,2), new Vector2f(3,0)});;
        SuperJoin bottom33 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("bottom"), superMesh.superMesh.get("right"), superMesh.superMesh.get("front")}, new Vector2f[]{new Vector2f(3,3), new Vector2f(3,0), new Vector2f(0,0)});;
...
//        SuperJoin bottom33 = new SuperJoin(new SuperSurface[]{superMesh.superMesh.get("back"), superMesh.superMesh.get("left"), superMesh.superMesh.get("top")}, new Vector2f[]{new Vector2f(3,0), new Vector2f(3,0), new Vector2f(0,0)});;
        ...
        superJoins.add(right10);
        superJoins.add(right11);
        superJoins.add(right12);
        superJoins.add(right13);

        superJoins.add(right20);
        superJoins.add(right21);
        superJoins.add(right22);
        superJoins.add(right23);

        superJoins.add(right30);
        superJoins.add(right31);
        superJoins.add(right32);
        superJoins.add(right33);

        superJoins.add(top00);
        superJoins.add(top01);
        superJoins.add(top02);
        superJoins.add(top03);

        superJoins.add(top10);
        superJoins.add(top11);
        superJoins.add(top12);
        superJoins.add(top13);

        superJoins.add(top20);
        superJoins.add(top21);
        superJoins.add(top22);
        superJoins.add(top23);

        superJoins.add(top30);
        superJoins.add(top31);
        superJoins.add(top32);
        superJoins.add(top33);

        superJoins.add(bottom00);
        superJoins.add(bottom01);
        superJoins.add(bottom02);
        superJoins.add(bottom03);

        superJoins.add(bottom10);
        superJoins.add(bottom11);
        superJoins.add(bottom12);
        superJoins.add(bottom13);

        superJoins.add(bottom20);
        superJoins.add(bottom21);
        superJoins.add(bottom22);
        superJoins.add(bottom23);

        superJoins.add(bottom30);
        superJoins.add(bottom31);
